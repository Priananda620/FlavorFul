...
<div class="container py-5">
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div id="home-filters" class="d-flex flex-row justify-content-between transition-height overflow-hidden" propActive="false" style="height: 0px">
                <div class="dropdown w-100 me-1">
                    <button class="btn btn-secondary rounded dropdown-toggle w-100" type="button" id="dropdownMenuButton" data-bs-toggle="dropdown" aria-expanded="false">
                        Select Option
                    </button>
            ...
            <div class="pt-4">
                ...
                <div class="card mb-3 rounded">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="https://images.unsplash.com/photo-1504674900247-0877df9cc836?ixlib=rb-4.0.3&amp;ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&amp;auto=format&amp;fit=crop&amp;w=1170&amp;q=80" class="img-fluid rounded h-100" alt="Image">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body d-flex flex-column justify-content-between h-100">
...
<script>
    $(document).ready(function() {
        ...
        function fetchFoodAutoComplete(){
        ...
        $('#selected-recipe-container').on('click', '.selected-recipe', function() {
            ...
            selectedIngre.each(function() {
                ...
                selectedIngredients.push(innerHTML);
