...
<header class="bg-light position-sticky top-0 w-100" style="z-index: 100">
    <div class="container d-flex justify-content-between align-items-center py-3">
        ...
        <nav class="d-flex align-items-center">
            <div id="popup-menu" class="d-none position-fixed w-100 h-100 bg-danger start-0 top-0" style="z-index: 10000">
                <div class="container h-100 position-relative">
                    ...
                    <ul class="h-100 px-lg-5 text-decoration-none list-unstyled d-flex flex-column align-items-center justify-content-center">
                        ...
                        <li class="p-1 my-3 w-100">
                            <a class="btn btn-outline-warning border border-4 text-white px-5 py-2 w-100 fw-bold fs-1">About</a>
                        </li>
                        <li class="p-1 my-3 w-100">
                            <a class="btn btn-outline-warning border border-4 text-white px-5 py-2 w-100 fw-bold fs-1">Recipe</a>
                        </li>
                        <li class="p-1 my-3 w-100">
                            <a class="btn btn-outline-warning border border-4 text-white px-5 py-2 w-100 fw-bold fs-1">Account</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="position-relative cursor-pointer">
                    ...
                    <div class="position-absolute end-0 rounded" id="avatar-menu"
                        ...
                        <div class="rounded" style="background: #ffa500">
                            <a class="p-3 d-block border-bottom text-center" href="#">Menu Item 1</a>
                            <a class="p-3 d-block border-bottom text-center" href="#">Menu Item 2</a>
                            <a class="p-3 d-block text-center" href="#">Menu Item 3</a>
                        </div>
                    </div>
                </div>
            @else
